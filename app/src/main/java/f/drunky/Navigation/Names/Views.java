...
import f.drunky.ui.fragments.DebugFragment;
...
import f.drunky.ui.fragments.ConditionFragment;
...
public class Views {
    ...
    public static final String STATE = "CONDITION";
    ...
    private static HashMap<String, Class<? extends Fragment>> FillViews() {
        ...
        views.put(STATE, ConditionFragment.class);
        ...
        views.put(DEBUG, DebugFragment.class);
